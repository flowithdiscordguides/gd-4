...
**Build Command:** Task-dependent. Do not run build commands unless the user explicitly asks for verification that requires them.

**Test Command:** Task-dependent. Prefer the project's existing verification commands when the user authorizes running them.
...
- Do not run any build, compile, or transpile commands unless the user explicitly asks for verification that requires them.
