...
8. **IDENTIFY** task-relevant `.codex/progress-history-[task].md` files if the current task scope is already clear.
...
9. **IDENTIFY** task-relevant `.codex/learned-history-[task].md` files if the current task scope is already clear.
...
10. **IDENTIFY** task-relevant `.codex/bugfix-[task].md` files if the current task scope is already clear. Read the
